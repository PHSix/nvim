    ...
    config = function()
      ...
      conform.setup {
        formatters_by_ft = {
          lua = { 'stylua' },
          python = { 'black', 'isort' },
          javascript = { 'oxfmt', 'eslint', 'biome', 'prettier', stop_after_first = true },
          typescript = { 'oxfmt', 'eslint', 'biome', 'prettier', stop_after_first = true },
          javascriptreact = { 'oxfmt', 'eslint', 'biome', 'prettier', stop_after_first = true },
          typescriptreact = { 'oxfmt', 'eslint', 'biome', 'prettier', stop_after_first = true },
          html = { 'prettier' },
          css = { 'prettier' },
          json = { 'prettier' },
          markdown = { 'prettier' },
