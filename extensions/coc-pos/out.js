...
const require_debounce = __commonJS({
  'node_modules/.pnpm/debounce@2.0.0/node_modules/debounce/index.js': function (exports2, module2) {
...
const import_coc2 = require('coc.nvim')

const import_debounce = __toESM(require_debounce())

// src/utils.ts
const invaildFileName = /* @__PURE__ */ new Set([
  'index.ts',
  'index.tsx',
  'index.js',
  'index.jsx',
